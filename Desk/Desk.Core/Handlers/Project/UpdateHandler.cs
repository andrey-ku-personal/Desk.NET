...
public class UpdateHandler : IRequestHandler<UpdateCommand, ProjectModel>
{
    ...
    public async Task<ProjectModel> Handle(UpdateCommand command, CancellationToken cancellationToken)
    {
